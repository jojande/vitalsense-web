  ...
  template: `
    <div class="appointments-view">
      <header class="view-header">
        ...
        <p>Administra tus citas programadas y pasadas.</p>
      </header>
      ...
      <div class="appointments-container" *ngIf="!isLoading(); else loading">
        <div class="appointments-list" *ngIf="bookedAppointments().length > 0; else noResults">
          <div class="appointment-card" *ngFor="let appt of bookedAppointments()">
            ...
            <div class="card-actions">
              <button class="action-link" *ngIf="appt.status === 'SCHEDULED' || appt.status === 'CONFIRMED'" (click)="startConsultation(appt)">
                Iniciar Consulta
              </button>
        ...
        <ng-template #noResults>
          <div class="empty-state">
            ...
            <h3>No registra consultas programadas en su historial.</h3>
          </div>
        </ng-template>
      </div>
...
export class DoctorAppointmentListComponent implements OnInit {
  ...
  startConsultation(appt: any) {
    alert('Funcionalidad de iniciar consulta próximamente.');
  }
